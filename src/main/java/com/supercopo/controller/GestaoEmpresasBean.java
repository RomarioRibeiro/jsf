...
import com.supercopo.model.TipoEmpresa;
import com.supercopo.repository.Empresas;
import com.supercopo.repository.RamoAtividades;
import com.supercopo.service.CadastroEmpresaService;
import com.supercopo.util.FaceMessages;
@Named
@ViewScoped
public class GestaoEmpresasBean implements Serializable {
    ...
    public void prepararEdicao(){
    	ramoAtividadeConverter = new RamoAtividadeConvert(Arrays.asList(empresa.getRamoAtividade()));
    }
    ...
    public List<RamoAtividade> completarRamoAtividade(String termo) {
        ...
        ramoAtividadeConverter = new RamoAtividadeConvert(listaRamoAtividades);
